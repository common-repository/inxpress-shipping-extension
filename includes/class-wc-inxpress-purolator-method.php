...
/**
 * WooCommerce InXpress Purolator Method
 *
...
/**
 * InXpress Purolator shipping method
 *
 * @property contain all the needed method definitions for InXress Shipping Fee Calculation
 */
class WC_Inxpress_Purolator_Method extends WC_Inxpress_Method
{
	...
	public function __construct($instance_id = 0)
	{
		...
		$this->id                 = 'inxpress_purolator';
		$this->method_title       = __('InXpress Purolator');
		$this->method_description = __('Using InXpress Purolator method');
		...
		$this->instance_form_fields = array_merge(
			array(
				'title' => array(
					...
					'default'     => __('Purolator', 'woocommerce'),
				),
			),

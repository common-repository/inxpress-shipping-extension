...
/**
 * WooCommerce InXpress StarTrack Method
 *
...
/**
 * InXpress StarTrack shipping method
 *
 * @property contain all the needed method definitions for InXpress Shipping Fee Calculation
 */
class WC_Inxpress_StarTrack_Method extends WC_Inxpress_Method
{
	...
	public function __construct($instance_id = 0)
	{
		...
		$this->id                 = 'inxpress_startrack';
		$this->method_title       = __('InXpress StarTrack');
		$this->method_description = __('Using InXpress StarTrack method');
		...
		$this->instance_form_fields = array_merge(
			array(
				'title'            => array(
					...
					'default'     => __('StarTrack', 'woocommerce'),
				),
			),

...
/**
 * WooCommerce InXpress DHLExpress Method
 *
 ...
 */
class WC_Inxpress_DHLExpress_Method extends WC_Inxpress_Method
{
	...
	public function __construct($instance_id = 0)
	{
		...
		$this->id                 = 'inxpress_dhl_express';
		$this->method_title       = __('InXpress DHL Express');
		$this->method_description = __('Using InXpress DHL Express method');
